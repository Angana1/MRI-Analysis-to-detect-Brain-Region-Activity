## 🧠 Structural and Functional MRI Analysis to detect Hand and Foot Movement Representations
...
Smoothing. We build a General Linear Model (GLM) by creating a Design Matrix and find the Statistical Maps, Activation Maps and AAL Atlas Overlay for the activated brain regions. We 
Principal Component Analysis (PCA) to identify the functional networks activated in the brain regions during stimuli, and compare the findings with our conclusions from GLM Analysis. 
